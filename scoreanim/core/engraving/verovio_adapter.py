...
from scoreanim.core.engraving.verovio.identity import (
    _attach_onset, _build_elements, _chord_group, _identity_for)
from scoreanim.core.engraving.verovio.synthesis import (
    _synthesize_repeats, _synthesize_slashes)
