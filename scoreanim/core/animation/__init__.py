...
__all__ = [
    ...
    "glow_defaults",
    "glow_scope", "glow_track", "inert_trigger_overrides", "intensity_at",
    "is_animated",
    "is_retimeable",
    ...
    "resolve_durations",
    "reveal_x",
    "nearest_head", "scale_pivots", "spec_envelope", "split_effect_name", "stem_scale_caps",
    "takes_part_color",
    "trigger_intensities",
