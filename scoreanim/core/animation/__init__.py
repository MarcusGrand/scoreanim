...
from scoreanim.core.animation.pulse import (SystemPulse, pulse_scale,
                                            read_pulse)
...
__all__ = [
    ...
    "SystemPulse", "SystemRevealTrack", "TINTED_KINDS", "Trigger",
    "TriggerSchedule",
    ...
    "is_animated",
    "is_revealed", "modulate_state", "peak_reference", "pulse_scale",
    "quantize_beats",
    "read_pulse", "read_volume", "resolve_durations", "reveal_x",
